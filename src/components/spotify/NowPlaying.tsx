...
import styles from 'src/components/spotify/now-playing.module.scss';
...
export const NowPlaying: FC<ISpotifyCurrentlyPlaying> = React.memo(
	({ songUrl, album, artist, albumImageUrl, isPlaying, title }) => {
		return (
				...
				>
					...
					<div className={styles.player}>
						...
						<div className={styles.player_metadata}>
							...
							{isPlaying && (
								<div className={styles.track}>{title}</div>
							)}
						</div>
						<svg
							className={styles.spotify_logo}
							width="25"
							height="25"
							viewBox="0 0 168 168"
							focusable="false"
...
NowPlaying.defaultProps = {
	...
	artist: 'Not Playing',
	title: 'Not Playing',
	albumImageUrl: 'https://www.placecage.com/200/200'
};
